...
export const PACK_POST_FEAR_REJOIN_TICKS = 220; // temporary regroup window after fear expires
export const PACK_POST_FEAR_REJOIN_FORCE_MULT = 1.35; // stronger pack-seek steering right after fear
...
export const PACK_ANCHOR_RETURN_FORCE = 1.35; // soft leash steering weight toward pack anchor
export const PACK_ANCHOR_HARD_RETURN_FORCE = 2.2; // hard leash steering weight toward pack anchor
...
export const STARVING_PACK_LEADER_MULT = 0.52;
export const STARVING_PACK_ALIGNMENT_MULT = 0.48;
export const STARVING_PACK_COHESION_MULT = 0.56;
export const STARVING_PACK_SEEK_MULT = 0.62;
