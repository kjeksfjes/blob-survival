...
export const PACK_ANCHOR_LEASH_START = 600; // beyond this, isolated members are treated as stragglers and pulled back
export const PACK_ANCHOR_LEASH_HARD = 900; // hard leash distance where return-to-pack force overrides normal flocking
...
export const PACK_REJOIN_ISOLATION_NEIGHBORS = 2; // treat <= this many nearby packmates as isolated for regrouping logic
export const PACK_REJOIN_URGENT_ISOLATION_TICKS = 110; // sustained sparse-neighbor time before forcing stronger regroup behavior
...
export const FEEDING_MODE_LEADER_MULT = 0.52; // reduce leader-follow while actively feeding, but keep enough cohesion to stay flocked
export const FEEDING_MODE_ALIGNMENT_MULT = 0.56; // reduce pack alignment while actively feeding, but avoid full pack break-up
export const FEEDING_MODE_COHESION_MULT = 0.50; // reduce pack cohesion while actively feeding, but retain group shape
