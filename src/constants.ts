...
export const PREDATOR_PLANT_EAT_EFFICIENCY = 0.72; // predators digest plant food less efficiently, but can survive failed hunts
...
export const PREDATOR_METABOLISM_MULT = 0.80; // weapon-bearers burn less baseline metabolism to reduce starvation collapses
...
export const LATCH_DAMAGE_MULT = 0.55;      // fraction of WEAPON_DAMAGE applied per latch tick
