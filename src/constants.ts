...
export const WEAPON_UPKEEP_PER_BLOB = 0.06; // passive upkeep per weapon blob per tick
...
export const EAT_COOLDOWN_TICKS = 3; // ticks after a bite before next bite
export const EAT_MAX_ITEMS_PER_SUBSTEP = 2; // hard cap on food pellets eaten per substep
...
export const NON_PREDATOR_EAT_EFFICIENCY = 0.9;
export const PREDATOR_PLANT_EAT_EFFICIENCY = 0.55; // predators digest plant food less efficiently
...
export const PREDATOR_URGENT_FORAGE_FRACTION = 0.18; // only very-starved predators prioritize food over hunt intent
export const PREDATOR_METABOLISM_MULT = 0.86; // weapon-bearers burn slightly less baseline metabolism to stabilize hunt viability
