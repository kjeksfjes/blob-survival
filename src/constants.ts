...
export const METABOLISM_COST_PER_BLOB = 0.11; // energy/tick/blob
...
export const EAT_FULL_STOP_FRACTION = 0.76; // stop eating at this energy fraction (satiety enter)
export const EAT_RESUME_FRACTION = 0.68; // resume eating at this energy fraction (satiety exit)
...
export const PHOTO_ENERGY_PER_TICK = 0.72; // multiplied by genome.photoEfficiency (0.2-0.5)
...
export const PACK_OFFSHOOT_CHANCE_ASEXUAL = 0.035; // chance a single-parent birth starts a new pack within the same clan
export const PACK_OFFSHOOT_CHANCE_SEXUAL_SAME_PACK = 0.09; // chance a two-parent same-pack birth buds into a new pack
...
export const FOOD_SIGNAL_DECAY_TICKS = 100;
...
export const FOOD_SIGNAL_RELAY_ATTENUATION = 0.72;
