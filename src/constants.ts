...
export const FOOD_DUST_EVENT_CAP = 4096; // transient ring-buffered bite VFX events
export const FOOD_DUST_EVENTS_MAX_PER_FRAME = 64; // event consume cap per rendered frame
export const FOOD_DUST_BURST_COUNT = 8; // particles spawned per plant bite event
export const FOOD_DUST_PARTICLE_MAX = 1800; // hard cap on active dust particles
export const FOOD_DUST_LIFETIME_MIN_S = 2.80;
export const FOOD_DUST_LIFETIME_MAX_S = 5.60;
export const FOOD_DUST_RADIUS_MIN = 1.4;
export const FOOD_DUST_RADIUS_MAX = 3.6;
export const FOOD_DUST_SPEED_MIN = 26; // px/sec
export const FOOD_DUST_SPEED_MAX = 104; // px/sec
export const FOOD_DUST_DRIFT_UP_ACCEL = 24; // px/sec^2
export const FOOD_DUST_DRAG = 0.985; // velocity damping per 60fps-equivalent frame
export const FOOD_DUST_DIRECTIONAL_BIAS = 1.8; // additional velocity bias in eater movement direction
export const FOOD_DUST_INTENSITY = 0.72; // base brightness for bite dust
...
export const PREDATOR_REPRO_ENERGY_THRESHOLD_ADD = 0.26; // predators need notably higher energy fraction before reproducing
export const PREDATOR_REPRO_COOLDOWN_MULT = 3.0; // stronger predator reproduction cooldown multiplier
export const PREDATOR_REPRO_FALLBACK_MULT = 2.6; // stronger predator asexual fallback delay multiplier
...
export const METABOLISM_COST_PER_BLOB = 0.085; // energy/tick/blob (slightly reduced to lower starvation-dominant collapses)
...
export const PREDATOR_PLANT_EAT_EFFICIENCY = 0.42; // predators digest plant food much less efficiently, forcing successful hunts
...
export const PHOTO_STACK_MAINTENANCE_QUAD = 0.18; // nonlinear extra maintenance when stacking many photosynth blobs
export const PHOTO_REPRO_PENALTY_START_SHARE = 0.34; // non-core photo share where repro penalty starts
export const PHOTO_REPRO_PENALTY_FULL_SHARE = 0.80; // non-core photo share where repro penalty reaches max
export const PHOTO_REPRO_THRESHOLD_ADD_MAX = 0.10; // max additional reproduction energy threshold from high photo share
export const PHOTO_REPRO_COOLDOWN_MULT_MAX = 0.45; // max additional reproduction cooldown multiplier from high photo share
...
export const CREATURE_SIZE_HEALTH_CAP_EXPONENT = 1.10;
export const CREATURE_SIZE_WEAPON_UPKEEP_EXPONENT = 1.00;
export const FAT_ENERGY_BONUS = 80; // extra max energy per FAT blob
export const CREATURE_HEALTH_FROM_MAX_ENERGY = 1.0;
export const CREATURE_HEALTH_SCALE_MIN = 0.65;
export const CREATURE_HEALTH_SCALE_MAX = 1.6;
export const CREATURE_HEALTH_SCALE_METABOLISM_MULT = 0.30; // extra metabolism per +1.0 healthScale above baseline
export const HEALTH_STARVATION_RAMP_TICKS = 300;
export const HEALTH_STARVATION_RAMP_MAX_MULT = 2.5;
export const HEALTH_REGEN_ENERGY_THRESHOLD = 0.65;
export const HEALTH_RECENT_ATTACK_TICKS = 180;
export const HEALTH_STARVATION_DRAIN_RATE_DEFAULT = 0.16;
export const HEALTH_BURST_DAMAGE_MULT_DEFAULT = 1.0;
export const HEALTH_LATCH_DAMAGE_MULT_DEFAULT = 1.0;
export const HEALTH_REGEN_RATE_DEFAULT = 0.12;
...
export const PREDATION_VERY_HUNGRY_FRACTION = 0.06; // predator emergency-only relax gate; very low to keep cannibalism rare
...
export const LATCH_REFRESH_RANGE_MULT = 1.55; // refresh latch timer while weapon remains near prey blob
...
export const LATCH_ESCAPE_ENERGY_WEIGHT = 0.65;
export const LATCH_ESCAPE_HEALTH_WEIGHT = 0.35;
export const LATCH_ESCAPE_TIMER_DRAIN_MAX_BONUS = 8;
export const LATCH_ESCAPE_REFRESH_PENALTY_MAX = 0.85;
...
export const ZOMBIE_CONVERSION_TICKS_DEFAULT = 140;
...
export const PREDATOR_SIZE_LATCH_REFRESH_MAX_MULT = 1.15;
...
export const CLAN_LEADER_WEIGHT = 0.68;
...
export const PACK_SEEK_WEIGHT = 0.58;
export const PACK_SEEK_MIN_DISTANCE = 210;
export const PACK_PERSISTENT_COHESION_WEIGHT = 1.18;
export const PACK_PERSISTENT_ALIGNMENT_WEIGHT = 1.15;
...
export const PACK_REJOIN_FORCE = 1.42;
export const PACK_REJOIN_MAX_DIST = 3200;
export const PACK_REJOIN_HUNGER_GATE = 0.28;
export const PACK_POST_FEAR_REJOIN_TICKS = 320; // temporary regroup window after fear expires
export const PACK_POST_FEAR_REJOIN_FORCE_MULT = 1.65; // stronger pack-seek steering right after fear
...
export const PACK_ANCHOR_LEASH_START = 450; // beyond this, isolated members are treated as stragglers and pulled back
export const PACK_ANCHOR_LEASH_HARD = 700; // hard leash distance where return-to-pack force overrides normal flocking
export const PACK_ANCHOR_RETURN_FORCE = 1.9; // soft leash steering weight toward pack anchor
export const PACK_ANCHOR_HARD_RETURN_FORCE = 3.1; // hard leash steering weight toward pack anchor
export const PACK_STRAGGLER_ISOLATION_TICKS = 180; // isolation duration before straggler leash behavior activates
export const PACK_STRAGGLER_RELEASE_NEIGHBORS = 2; // straggler state clears once this many same-pack neighbors are nearby
export const PACK_REJOIN_ISOLATION_NEIGHBORS = 3; // treat <= this many nearby packmates as isolated for regrouping logic
export const PACK_REJOIN_URGENT_ISOLATION_TICKS = 55; // sustained sparse-neighbor time before forcing stronger regroup behavior
export const PACK_REJOIN_URGENT_FORCE_MULT = 1.7; // extra long-range regroup force during urgent regroup
export const PACK_REJOIN_URGENT_SOCIAL_MULT = 1.35; // boost leader/alignment/cohesion while urgently regrouping
...
export const BOID_COHESION_RADIUS = 560;
export const BOID_SEPARATION_WEIGHT = 0.95;
export const BOID_ALIGNMENT_WEIGHT = 1.1;
export const BOID_COHESION_WEIGHT = 1.0;
export const BOID_SEPARATION_HARD_WEIGHT = 1.55;
...
export const PACK_HUNGER_RALLY_AVG_ENERGY_ON_FRAC = 0.64; // pack-level hunger trigger from average energy fraction
export const PACK_HUNGER_RALLY_HUNGRY_FRACTION_ON = 0.34; // minimum share of hungry members to trigger rally
export const PACK_HUNGER_RALLY_MIN_SIGNAL = 0.5; // require a strong scout/direct signal ("large food")
...
export const PACK_SCOUT_ROLE_MIN_PACK_SIZE = 3; // packs larger than 2 should maintain a dedicated scout
export const PACK_SCOUT_ROLE_MAX_FRAC = 0.06; // dedicated scout quota as fraction of eligible non-predators
export const PACK_SCOUT_ROLE_MAX_COUNT = 2; // hard cap on active scouts per pack to keep packs cohesive
...
export const PACK_SCOUT_MIN_REMAINING_AGE_TICKS = 600; // avoid assigning scouts that are close to old-age death
export const PACK_SCOUT_HIGH_ENERGY_FRAC = 0.34; // scouts start outbound patrol much earlier, well before packs reach starvation pressure
export const PACK_SCOUT_FOOD_SENSE_MULT = 2.6; // active scouts detect food from much farther away
export const PACK_SCOUT_REPORT_MIN_PLANT_COUNT = 3; // scouts only broadcast when they see a meaningful plant cluster
export const PACK_SCOUT_REPORT_MIN_GAP_TICKS = 90; // minimum gap between direct scout reports for the same scout
export const PACK_SCOUT_REPORT_NOVELTY_DISTANCE = 120; // hotspot centroid movement needed to count as a new discovery
export const PACK_SCOUT_REPORT_NOVELTY_STRENGTH_DELTA = 0.15; // required signal-strength increase to re-report unchanged hotspots
export const PACK_SCOUT_REPORT_ONSITE_RADIUS_MULT = 0.8; // scout on-site radius as a fraction of hold radius
export const PACK_SCOUT_REPORT_ONSITE_MIN_PACKMATES = 1; // same-pack creatures near hotspot needed to suppress "new patch" reports
export const PACK_SCOUT_REPORT_HOLD_RADIUS = 220; // scouts try to stay near reported plant hotspot within this radius
export const PACK_SCOUT_REPORT_HOLD_WEIGHT = 1.05; // steering weight that keeps scouts anchored on reported hotspots
export const PACK_SCOUT_HEARTBEAT_TICKS = 75; // periodic relay-only scout heartbeat interval
export const PACK_SCOUT_HEARTBEAT_STRENGTH = 0.18; // weak scout heartbeat strength (non-direct signal)
export const PACK_SCOUT_AWAY_FROM_PACK_WEIGHT = 0.7; // push high-energy scouts out of dense pack center
export const PACK_SCOUT_PATROL_WEIGHT = 0.65; // systematic world patrol steering weight
...
export const PACK_SCOUT_PATROL_LANES = 7; // number of horizontal sweep lanes for methodical scout patrols
export const PACK_SCOUT_PATROL_DIRECTION_WEIGHT = 0.28; // extra forward bias along current sweep direction to reduce whirl
...
export const STARVING_PACK_LEADER_MULT = 0.72;
export const STARVING_PACK_ALIGNMENT_MULT = 0.66;
export const STARVING_PACK_COHESION_MULT = 0.74;
export const STARVING_PACK_SEEK_MULT = 0.86;
...
export const HUNGRY_ROAM_FAR_SCATTER_MULT = 0.65; // cap exploration fan-out so hungry packs don't atomize
export const PREDATOR_PACK_COHESION_MULT = 0.78; // predators stay socially looser than non-predators
export const PREDATOR_PACK_ALIGNMENT_MULT = 0.84; // predators align less tightly than non-predators
export const PREDATOR_PACK_LEADER_MULT = 0.82; // predators follow pack leaders with lower weight
export const PREDATOR_PACK_SEPARATION_MULT = 1.12; // predators preserve slightly wider spacing
...
export const FEEDING_MODE_LEADER_MULT = 0.72; // reduce leader-follow while actively feeding, but keep enough cohesion to stay flocked
export const FEEDING_MODE_ALIGNMENT_MULT = 0.74; // reduce pack alignment while actively feeding, but avoid full pack break-up
export const FEEDING_MODE_COHESION_MULT = 0.70; // reduce pack cohesion while actively feeding, but retain group shape
export const FEEDING_MODE_SEPARATION_MULT = 1.20; // increase local separation while actively feeding
